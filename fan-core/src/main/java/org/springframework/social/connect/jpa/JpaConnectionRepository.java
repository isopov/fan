...
public class JpaConnectionRepository implements ConnectionRepository {
    ...
    public JpaConnectionRepository(String userId, JpaTemplate jpaTemplate,
    ...
    public Connection<?> getConnection(ConnectionKey connectionKey) {
        try {
            return connectionMapper.mapEntity(jpaTemplate.get(userId, connectionKey.getProviderId(),
    ...
    public void addConnection(Connection<?> connection) {
        try {
            ...
            jpaTemplate.createRemoteUser(userId, data.getProviderId(), data.getProviderUserId(), data.getDisplayName(),
